#include "old_compilation_test.hpp"
#include "grid/exploration/direction_to.hpp"
#include "grid/exploration/reachable_positions.hpp"
#include "grid/exploration/reachable_squares.hpp"
